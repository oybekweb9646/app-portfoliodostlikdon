           ...
           <AdminLayout>
               <div className="admin-news">
                   <div className="d-flex justify-content-between">
                       <div><h5>News</h5></div>
                       <div><Button color='success' onClick={changeModal} type="button">Qo'shish</Button></div>
                   </div>
                   ...
                   <table className="table table-striped table-hover mt-4 table-bordered">
                       ...
                       {this.props.news.map(item => (
                           <tr>
                               ...
                               <td>
                               <button type='button' className="btn btn-success mr-2" onClick={() => editNews(item)}>E</button>
...
: ""
        ...
        <input type="file" onChange={savePhoto} className="form-control" id="file"/>
...
<Button type='button' onClick={() => {this.props.updateState( {selectedNews: {}, selectedImage: ""});changeModal()}} className="btn btn-danger">Cancel</Button>
    </ModalFooter>
</AvForm>
</Modal>
